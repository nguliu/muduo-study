...
int sockets::accept(int sockfd, struct sockaddr_in* addr)
{
  ...
  if (connfd < 0)
  {
  	/*LOG_SYSERR登记错误时调用了系统调用，可能会更改errno的值，所以需要先将errno的值保存下来*/
    ...
    switch (savedErrno)
    {
      ...
      case ENOTSOCK:
      case EOPNOTSUPP:
        // unexpected errors	以上为致命错误，需要终止程序
        LOG_FATAL << "unexpected error of ::accept " << savedErrno;
        break;
      default:		//未知错误，也需要终止程序
...
// readv与read不同之处在于，接收的数据可以填充到iov指定的多个缓冲区中
